...
\begin{table*}[h]
  ...
  \begin{tabularx}{\linewidth}{lrlrX}
    ...
    \midrule
    RefS & 1,500 & TarS & 1,500 &  RefS consists of three segments of size~500 bases. To build TarS, segment~I is mutated~2\%, II is inversely repeated and III is duplicated. Read lines are 100~base long. \\
