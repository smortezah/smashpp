...
\begin{figure*}[!t]
  \centering
  \includegraphics[width=.95\linewidth]{schema.pdf}
...
%  \end{equation*}
 ...
 \begin{figure*}[!h]
   \centering
   \includegraphics[width=.85\linewidth]{data_struct.pdf}
