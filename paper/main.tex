...
%  \end{equation*}
 ...
 \begin{figure*}[!h]
   \centering
   \includegraphics[width=.87\linewidth]{fig/data_struct.pdf}
...
\begin{figure*}[!h]
  \centering
  \includegraphics[width=\linewidth]{fig/real.pdf}
...
\begin{figure*}[!h]
  \centering
  \includegraphics[height=.95\textheight]{fig/compare_smash.pdf}
