...
The schema of the proposed method is illustrated in Fig.~\ref{fig.schema}. There are five major stages in \smashpp: (1) reference-based compression, (2) filtering and segmentation, (3) reference-free compression, (4) positions aggregation and (5) visualization. In stage (1), model of the reference is built and the target is compressed using that model.
