...
\begin{algorithm}[H]
  ...
  \begin{algorithmic}[1]
    \Require sketch width $w$, sketch depth $d$, logarithm base $b>1$, independent hash functions $h_{1\ldots d}: U\to \{1\ldots w\}$
    ...
    \If{\textsc{IncreaseDecision($c$)}}
    \For{$k\gets 1\ldots d$}
