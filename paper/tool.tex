...
cd example/
\end{code}
In this directory, we have provided a 1000 byte reference sequence, \mono{ref}, and a 1000 byte target sequence, \mono{tar}.


The result is shown in Fig.~\ref{fig.example}.
