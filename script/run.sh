...
if [[ $SYNTHETIC -eq 1 ]]; then
  ...
  ./goose-fastqsimulation -eh -eo -es -edb -rn 2 -ri 10 -ra 50 -rm 0 \
                          -ls 100 -n 2 -f 0.2,0.3,0.3,0.2,0.0 -s 101         r_a
  ./goose-fastqsimulation -eh -eo -es -edb -rn 1 -ri 10 -ra 50 -rm 0 \
                          -ls 100 -n 2 -f 0.25,0.25,0.25,0.25,0.0 -s 68      r_b
  ./goose-fastqsimulation -eh -eo -es -edb -rn 3 -ri 10 -ra 50 -rm 0 \
                          -ls 100 -n 2 -f 0.25,0.25,0.25,0.25,0.0 -s 3       r_c
  ./goose-fastqsimulation -eh -eo -es -edb -rn 1 -ri 10 -ra 50 -rm 0 \
                          -ls 100 -n 2 -f 0.3,0.2,0.2,0.3,0.0 -s 1785        r_d
  ./goose-fastqsimulation -eh -eo -es -edb -rn 4 -ri 10 -ra 50 -rm 0 \
                          -ls 100 -n 2 -f 0.25,0.25,0.25,0.25,0.0 -s 228     r_e
  ...
  ./goose-fastqsimulation -eh -eo -es -edb -rn 2 -ri 50 -ra 500 -rm 0 \
                          -ls 100 -n 200 -f 0.25,0.25,0.25,0.25,0.0 -s 1001  r_a
  ./goose-fastqsimulation -eh -eo -es -edb -rn 1 -ri 50 -ra 500 -rm 0 \
                          -ls 100 -n 200 -f 0.3,0.2,0.2,0.3,0.0 -s 608       r_b
  ./goose-fastqsimulation -eh -eo -es -edb -rn 3 -ri 50 -ra 500 -rm 0 \
                          -ls 100 -n 200 -f 0.2,0.3,0.3,0.2,0.0 -s 30        r_c
  ./goose-fastqsimulation -eh -eo -es -edb -rn 1 -ri 50 -ra 500 -rm 0 \
                          -ls 100 -n 200 -f 0.25,0.25,0.25,0.25,0.0 -s 17805 r_d
  ./goose-fastqsimulation -eh -eo -es -edb -rn 4 -ri 50 -ra 500 -rm 0 \
                          -ls 100 -n 200 -f 0.25,0.25,0.25,0.25,0.0 -s 2028  r_e
  ...
  ./goose-fastqsimulation -eh -eo -es -edb -rn 4 -ri 500 -ra 1500 -rm 0 \
