...
if [[ $RUN -eq 1 ]]; then
  ### S
  ./smashpp -r RefS -t TarS \
    -rm 4,0,0.4,0.95:6,0,0.2,0.95:8,0,0.1,0.95:10,0,0.05,0.95 -w 31
  ...
  ### XL
  ./smashpp -r RefXL -t TarXL -rm 14,0,0.005,0.95/1,0,0.5,0,95 -w 750 -th 1.9
  ./smashpp -viz -l 5 -p 1 -m 20000000 -o XL.svg RefXL-TarXL.pos
  ### Mut
  ./smashpp -r RefMut -t TarMut -rm 20,0,0.002,0.95/5,0,0.6,0.95 -w 100 -th 1.7
  ./smashpp -viz -l 5 -p 1 -m 600000 -o Mut.svg RefMut-TarMut.pos
fi