...
if gga7_mga7:
        ...
        ref = '7.seq'
        tar = '7.seq'
        main_par = ' -rm 14,0,0.005,0.95/5,0,1,0.95 -f 150 -m 300000 -d 8000 -th 1.9 -nr '
        viz_par = ' -viz -l 1 '
        execute(smashpp + main_par + ' -r ' + path_ref + ref + ' -t ' +
                path_tar + tar)
        execute(smashpp + viz_par + ref + '.' + tar + '.pos')
...
if gga6_mga8:
        ...
        ref = '6.seq'
        tar = '8.seq'
        main_par = ' -rm 14,0,0.005,0.95/5,0,1,0.95 -f 150 -m 130000 -d 7000 -th 1.9 -nr -sf '
        viz_par = ' -viz -l 1 '
        execute(smashpp + main_par + ' -r ' + path_ref + ref + ' -t ' +
                path_tar + tar)
        execute(smashpp + viz_par + ref + '.' + tar + '.pos')
...
if gga8_mga10:
        ...
        tar = '8.seq'
        ref = '10.seq'
        main_par = ' -rm 14,0,0.005,0.95/5,0,1,0.95 -f 150 -m 130000 -d 6000 -th 1.98 -nr -sf '
        viz_par = ' -viz -l 1 '
        execute(smashpp + main_par + ' -r ' + path_ref + ref + ' -t ' +
                path_tar + tar)
        execute(smashpp + viz_par + ref + '.' + tar + '.pos')
...
if gga9_mga11:
        ...
        ref = '11.seq'
        tar = '9.seq'
        main_par = ' -rm 14,0,0.005,0.95/5,0,1,0.95 -f 150 -m 50000 -d 6500 -th 1.9 -nr -sf -ar '
        viz_par = ' -viz -l 1 '
        execute(smashpp + main_par + ' -r ' + path_ref + ref + ' -t ' +
                path_tar + tar)
        execute(smashpp + viz_par + ref + '.' + tar + '.pos')
...
if gga14_mga16:
        ...
        ref = '14.seq'
        tar = '16.seq'
        main_par = ' -rm 14,0,0.005,0.95:7,0,0.01,0.95 -f 150 -m 200000 -d 3750 -th 1.8 -nr -sf -ar '
...
if gga13_mga15:
        ...
        ref = '13.seq'
        tar = '15.seq'
        main_par = ' -rm 14,0,0.005,0.95:7,0,0.01,0.95 -f 150 -m 100000 -d 4500 -th 1.87 -nr -sf -ar '
        viz_par = ' -viz -l 1 -o GGA13_MGA15.svg '
        execute(smashpp + main_par + ' -r ' + path_ref + ref + ' -t ' +
                path_tar + tar)
        execute(smashpp + viz_par + ref + '.' + tar + '.pos')
