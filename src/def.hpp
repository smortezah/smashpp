...
enum class Format { profile, filter, position, midposition, segment, self, json };
...
const std::vector<FilterType> SET_WTYPE{
    FilterType::rectangular, FilterType::hamming, FilterType::hann, FilterType::blackman,
    FilterType::triangular,  FilterType::welch,   FilterType::sine, FilterType::nuttall};
const std::vector<FilterScale> SET_FSCALE{FilterScale::s, FilterScale::m, FilterScale::l};
...
struct PosRow {
  ...
  PosRow(uint64_t beg_pos_ = 0, uint64_t end_pos_ = 0, prc_t ent_ = 0.0, prc_t self_ent_ = 0.0,
         uint8_t run_num_ = 0, std::string ref_ = "", std::string tar_ = "", uint64_t seg_num_ = 0,
         uint8_t round_ = 1)
      : beg_pos(beg_pos_),
        end_pos(end_pos_),
        ent(ent_),
...
static constexpr uint64_t POW2minus1[44]{
    0x0000000000,  0x00000000001, 0x00000000003, 0x00000000007, 0x000000000F,  0x0000000001F,
    0x0000000003F, 0x0000000007F, 0x00000000FF,  0x000000001FF, 0x000000003FF, 0x000000007FF,
    0x0000000FFF,  0x00000001FFF, 0x00000003FFF, 0x00000007FFF, 0x000000FFFF,  0x0000001FFFF,
    0x0000003FFFF, 0x0000007FFFF, 0x00000FFFFF,  0x000001FFFFF, 0x000003FFFFF, 0x000007FFFFF,
    0x0000FFFFFF,  0x00001FFFFFF, 0x00003FFFFFF, 0x00007FFFFFF, 0x000FFFFFFF,  0x0001FFFFFFF,
    0x0003FFFFFFF, 0x0007FFFFFFF, 0x00FFFFFFFF,  0x001FFFFFFFF, 0x003FFFFFFFF, 0x007FFFFFFFF,
    0x0FFFFFFFFF,  0x01FFFFFFFFF, 0x03FFFFFFFFF, 0x07FFFFFFFFF, 0xFFFFFFFFFF,  0x1FFFFFFFFFF,
    0x3FFFFFFFFFF, 0x7FFFFFFFFFF};
static constexpr uint16_t FREQ2[16]{
    // 2^n - 1
...
static const std::vector<std::string> LEVEL{
    ...
    "16,0,0.002,0.95/8,0,0.1,0.95:14,0,0.005,0.95/5,0,1,0.95:8,0,0.1,0.95:4,0,1,0.95",  // Level 5
    "20,0,0.002,0.95/5,0,0.05,0.95:14,0,0.005,0.95/3,0,1,0.95:8,0,0.1,0.95:4,0,1,0.95"  // Level 6
};
...
static const std::vector<std::vector<std::string>> COLORSET{
    ...
    {"#F8766D", "#D89000", "#A3A500", "#39B600", "#00BF7D", "#00BFC4", "#00B0F6", "#9590FF",
    "#E76BF3", "#FF62BC"},
    {"#0000ff", "#00aaff", "#00ffff", "#00ffaa", "#00ff55", "#55ff00", "#aaff00", "#ffff00",
    "#ffaa00", "#ff0000"},
    {"#0000ff", "#0055ff", "#00aaff", "#00ffff", "#00ffaa", "#00ff55", "#00ff00", "#55ff00",
    "#aaff00", "#ffff00", "#ffaa00", "#ff5500", "#ff0000"},
    */
    // #1
    {"#90ee90", "#70de94", "#61d59b", "#53cda4", "#45c5b0", "#2d9eb4", "#237eac", "#195ea4",
     "#103e9b", "#00008b"}
    /*
    {"#90ee90", "#7fe690", "#70de94", "#61d59b", "#53cda4", "#45c5b0", "#39bdbd", "#2d9eb4",
    "#237eac", "#195ea4", "#103e9b", "#071f93", "#00008b"}
    */
};
}  // namespace smashpp
